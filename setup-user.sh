...
ansible-playbook --ask-become-pass user.yml --extra-vars "run_pacman=Y run_aur=Y ui=Y desktop=Y user=fabio profile=trout ssh=Y dotFilesPath=~/.config/dotFiles dotFilesPrivatePath=~/.config/dotFiles-private"
